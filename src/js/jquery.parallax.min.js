        ...
        n.prototype.transformSupport = function(t) {
            ...
            switch (t) {
                case "2D":
                    ...
                    break;
                case "3D":
                    o && (e.body.appendChild(n), n.style[l] = "translate3d(1px,1px,1px)", a = i.getComputedStyle(n).getPropertyValue(h), r = a !== s && a.length > 0 && "none" !== a, e.body.removeChild(n))
            }
            return r
        }, n.prototype.ww = null, n.prototype.wh = null, n.prototype.wcx = null, n.prototype.wcy = null, n.prototype.portrait = null, n.prototype.desktop = !navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|mobi|tablet|opera mini|nexus 7)/i), n.prototype.vendors = [null, ["-webkit-", "webkit"],
            ["-moz-", "Moz"],
            ["-o-", "O"],
            ["-ms-", "ms"]
        ], n.prototype.motionSupport = !! i.DeviceMotionEvent, n.prototype.orientationSupport = !! i.DeviceOrientationEvent, n.prototype.orientationStatus = 0, n.prototype.transform2DSupport = n.prototype.transformSupport("2D"), n.prototype.transform3DSupport = n.prototype.transformSupport("3D"), n.prototype.initialise = function() {
            "static" === this.$context.css("position") && this.$context.css({
                position: "relative"
            }), this.$layers.css({
//                position: "absolute",
//                display: "block",
//                height: this.$layers.find('img').height(),
//                width: this.$layers.find('img').width()
                /*
                left: 0,
                top: 0
                */
            ...
            this.ww = i.innerWidth, this.wh = i.innerHeight, this.wcx = this.ww / 2, this.wcy = this.wh / 2
            ...
            for (var o = null, a = 0, r = this.vendors.length; r > a; a++) if (o = null !== this.vendors[a] ? t.camelCase(this.vendors[a][1] + "-" + e) : e, i.style[o] !== s) {
                i.style[o] = n;
                break
            }
            ...
            !this.orientationSupport && this.relativeInput ? (this.bounds = this.element.getBoundingClientRect(), this.ex = this.bounds.left, this.ey = this.bounds.top, this.ew = this.bounds.width, this.eh = this.bounds.height, this.ecx = this.ew / 2, this.ecy = this.eh / 2, this.ix = (t.clientX - this.ex - this.ecx) / this.ecx, this.iy = (t.clientY - this.ey - this.ecy) / this.ecy, this.clipRelativeInput && (this.ix = Math.max(this.ix, -1), this.ix = Math.min(this.ix, 1), this.iy = Math.max(this.iy, -1), this.iy = Math.min(this.iy, 1))) : (this.ix = (t.clientX - this.wcx) / this.wcx, this.iy = (t.clientY - this.wcy) / this.wcy)
        };
        var h = {
